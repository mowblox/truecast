...
const Sidebar = () => {
  return (
    <div className="w-[268px] h-screen px-8 py-6 flex flex-col gap-12">
      <Logo />
...
const NavLink = ({ link }: { link: NavLink }) => {
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        "flex items-center gap-4 text-nowrap px-5 py-4 rounded-[15px] bg-primary bg-opacity-0 dark:text-white/60",
